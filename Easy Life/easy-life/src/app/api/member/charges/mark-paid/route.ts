...
import { listMemberCharges, updateMemberChargeStatus, confirmAmenityBookingByCharge } from "@/lib/server/records";
...
export async function POST(request: Request) {
  ...
  await confirmAmenityBookingByCharge(body.chargeId);
