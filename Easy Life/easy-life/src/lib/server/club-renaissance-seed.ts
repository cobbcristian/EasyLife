...
/**
 * Club Renaissance Golf Club — Sun City Center, FL demo tenant.
 * 2121 South Pebble Beach Blvd, Sun City Center, FL 33573 · (813) 633-1015
 * Membership: Alexis Macon · membership@clubrenaissance.com
 * (membershipsalesflorida@clublink.ca) · https://clubrenaissance.clublink.com/
 * 18-hole par-72 ClubLink course (front nine links-style / back nine conservation),
 * 4,651–6,701 yards. Mediterranean clubhouse with golf shop, Olympic-sized pool,
 * spa, fitness, and restaurant. Semi-private / ClubLink membership options.
 */
export const CLUB_RENAISSANCE_COMMUNITY_ID = "club-renaissance";
const MEMBER_EMAIL = "member.demo@clubrenaissance.com";
const MEMBER_NAME = "Sam Parker";
const SOCIAL_EMAIL = "member.social@clubrenaissance.com";
const SOCIAL_NAME = "Riley Chen";
const PM_EMAIL = "pm.demo@clubrenaissance.com";
const PM_NAME = "Alexis Macon";
const BOARD_EMAIL = "board.demo@clubrenaissance.com";
const BOARD_NAME = "Drew Hoffman";
const CLUB_PHONE = "(813) 633-1015";
const PRO_SHOP_PHONE = "(813) 633-1015";
const DINING_EMAIL = "dining@clubrenaissance.com";
const MEMBERSHIP_EMAIL = "membership@clubrenaissance.com"; // also membershipsalesflorida@clublink.ca
...
const amenities: AmenitySeed[] = [
  {
    ...
    description:
      "18-hole par-72 ClubLink course — links-style front nine and conservation-style back nine, 4,651–6,701 yards.",
    kind: "golf_course",
    unitCount: 8,
    holes: 18,
    hoursJson: golfHours,
  ...
  },
  {
    ...
    description:
      "Olympic-sized swimming pool at the Mediterranean clubhouse — laps, leisure, and member gatherings.",
    kind: "facility",
    unitCount: 1,
    holes: null,
    hoursJson: spaHours,
  ...
  {
    id: "cr-amenity-proshop",
    name: "Golf Shop",
    description:
      "Golf shop for tee times, apparel, and equipment — (813) 633-1015.",
    kind: "facility",
    unitCount: 1,
    holes: null,
  ...
  {
    id: "cr-amenity-clubhouse",
    name: "Mediterranean Clubhouse",
    description:
      "Mediterranean clubhouse with golf shop, Olympic-sized pool, spa, fitness, restaurant, and event spaces — a ClubLink property.",
    kind: "facility",
    unitCount: 1,
    holes: null,
    hoursJson: clubhouseHours,
...
const staff = [
  ...
  },
  {
    ...
    department: "Golf",
    email: "golf@clubrenaissance.com",
  ...
  },
  {
    ...
    department: "Golf",
    email: "golf.assistant@clubrenaissance.com",
    phone: PRO_SHOP_PHONE,
    category: "golf_pro",
    sortOrder: 11,
  },
  {
    ...
    email: "superintendent@clubrenaissance.com",
    phone: CLUB_PHONE,
    category: "golf_pro",
    sortOrder: 12,
  },
  ...
  },
  {
    ...
    department: "Events",
    email: "events@clubrenaissance.com",
    phone: CLUB_PHONE,
    category: "management",
    sortOrder: 21,
  },
...
const lessonPros = [
  {
    ...
    category: "golf",
    description:
      "Director of Golf. Instruction on the 18-hole par-72 ClubLink course (links front / conservation back) and practice greens.",
  },
  {
    id: "cr-pro-laura",
    name: "Jamie Chen",
...
const menuItems: Array<{ id: string; name: string; price: number; category: string }> = [
  { id: "cr-menu-b-omelet", name: "Clubhouse Omelet", price: 14, category: "Clubhouse Restaurant · Breakfast" },
  { id: "cr-menu-b-benedict", name: "Eggs Benedict", price: 16, category: "Clubhouse Restaurant · Breakfast" },
  { id: "cr-menu-b-fruit", name: "Fresh Fruit Plate", price: 11, category: "Clubhouse Restaurant · Breakfast" },
  { id: "cr-menu-l-burger", name: "Club Renaissance Burger", price: 17, category: "Clubhouse Restaurant · Lunch" },
  { id: "cr-menu-l-fish", name: "Grouper Sandwich", price: 19, category: "Clubhouse Restaurant · Lunch" },
  { id: "cr-menu-l-caesar", name: "Classic Caesar Salad", price: 13, category: "Clubhouse Restaurant · Lunch" },
  { id: "cr-menu-l-club", name: "Club Sandwich", price: 15, category: "Clubhouse Restaurant · Lunch" },
  { id: "cr-menu-d-salmon", name: "Pan-Seared Salmon", price: 32, category: "Clubhouse Restaurant · Dinner" },
  { id: "cr-menu-d-filet", name: "Filet Mignon", price: 48, category: "Clubhouse Restaurant · Dinner" },
  { id: "cr-menu-d-chicken", name: "Herb Roasted Chicken", price: 28, category: "Clubhouse Restaurant · Dinner" },
  { id: "cr-menu-d-cake", name: "Key Lime Tart", price: 10, category: "Clubhouse Restaurant · Desserts" },
  { id: "cr-menu-bar-wrap", name: "Turkey Avocado Wrap", price: 14, category: "Clubhouse Bar · Small Plates" },
  { id: "cr-menu-bar-wings", name: "Club Wings", price: 15, category: "Clubhouse Bar · Small Plates" },
  { id: "cr-menu-bar-flatbread", name: "Margherita Flatbread", price: 14, category: "Clubhouse Bar · Small Plates" },
  { id: "cr-menu-bar-iced", name: "Fresh-Brewed Iced Tea", price: 4, category: "Clubhouse Bar · Beverages" },
  { id: "cr-menu-bar-margarita", name: "Sun City Center Margarita", price: 12, category: "Clubhouse Bar · Cocktails" },
];
...
async function seedAmenities() {
  for (const amenity of amenities) {
    ...
    await prisma.amenity.upsert({
      ...
      create: {
        id: amenity.id,
        communityId: CLUB_RENAISSANCE_COMMUNITY_ID,
        name: amenity.name,
...
async function seedDining() {
  await prisma.provider.upsert({
    where: { id: "cr-provider-dining" },
    create: {
      id: "cr-provider-dining",
      communityId: CLUB_RENAISSANCE_COMMUNITY_ID,
      name: "Club Renaissance Dining",
      category: "Dining",
      type: "service",
      rating: 4.9,
      description:
...
const nearbyVendors = [
  {
    id: "cr-vendor-lawn",
    name: "Sun City Center Lawn & Landscape",
    category: "Lawn Care",
    rating: 4.8,
    email: "lawn@clubrenaissance.com",
    phone: "(813) 555-5101",
    description:
      "Weekly mowing, edging, and seasonal plantings for Club Renaissance homes near Pebble Beach Blvd.",
  },
  {
    id: "cr-vendor-pool",
    name: "Sun City Center Home Care",
    category: "Pool",
    rating: 4.7,
    email: "pool@clubrenaissance.com",
    phone: "(813) 555-5102",
    description:
      "Residential pool chemistry, weekly cleaning, and equipment service for Club Renaissance estates.",
  },
  {
    id: "cr-vendor-clean",
    name: "Pebble Beach Cleaning",
    category: "Cleaning",
    rating: 4.9,
    email: "cleaning@clubrenaissance.com",
    phone: "(813) 555-5103",
    description:
      "Housekeeping and deep cleans for villas and single-family homes in Club Renaissance Golf Club.",
  },
  {
    id: "cr-vendor-hvac",
    name: "Sun City Center Climate HVAC",
    category: "HVAC",
    rating: 4.6,
    email: "hvac@clubrenaissance.com",
    phone: "(813) 555-5104",
    description:
  ...
  {
    id: "cr-vendor-plumb",
    name: "Sun City Center Plumbing",
    category: "Plumbing",
    rating: 4.5,
    email: "plumbing@clubrenaissance.com",
    phone: "(813) 555-5105",
    description:
      "Same-day plumbing, fixture installs, and water heater service for Club Renaissance members.",
  },
  {
    id: "cr-vendor-windows",
    name: "Sun City Center Window Cleaning",
    category: "Window Cleaning",
    rating: 4.7,
    email: "windows@clubrenaissance.com",
    phone: "(813) 555-5106",
    description:
  ...
  {
    id: "cr-vendor-pest",
    name: "Sun City Center Pest Pros",
    category: "Pest Control",
    rating: 4.6,
    email: "pest@clubrenaissance.com",
    phone: "(813) 555-5107",
    description:
      "Quarterly pest control and seasonal mosquito treatments for Club Renaissance properties.",
  },
  {
    id: "cr-vendor-handyman",
    name: "Sun City Center Handyman Co.",
    category: "Handyman",
    rating: 4.8,
    email: "handyman@clubrenaissance.com",
    phone: "(813) 555-5108",
    description:
  ...
  },
  {
    ...
    category: "Painting",
    rating: 4.5,
    email: "paint@clubrenaissance.com",
    phone: "(813) 555-5109",
    description:
      "Interior and exterior painting for villas and estate residences throughout Club Renaissance.",
  },
] as const;
...
async function seedEventsAndBookings() {
  ...
  for (const event of events) {
    await prisma.communityEvent.upsert({
      where: { id: event.id },
      create: { ...event, communityId: CLUB_RENAISSANCE_COMMUNITY_ID, createdBy: "Club Renaissance Golf Club" },
      update: event,
    });
  }
  ...
  const bookings = [
    ...
    {
      id: "cr-booking-dining",
      amenityId: "cr-amenity-dining-grill",
      unitNumber: 1,
...
async function seedEngagement() {
  const announcements = [
    {
      id: "cr-announcement-golf",
      title: "Championship course in peak condition",
      body: "The 18-hole par-72 ClubLink course (4,651–6,701 yards; links front / conservation back) is in peak condition. Book tee times through the pro shop at (813) 633-1015 — early mornings recommended.",
      author: "Golf Shop",
      priority: "important",
    },
    {
      id: "cr-announcement-range",
  ...
  for (const a of announcements) {
    await prisma.announcement.upsert({
      where: { id: a.id },
      create: { ...a, communityId: CLUB_RENAISSANCE_COMMUNITY_ID },
      update: {
        title: a.title,
        body: a.body,
        author: a.author,
...
async function seedDocuments() {
  const documents = [
    {
      id: "cr-document-club-guide",
      title: "Club Renaissance Golf Club — Member Guide 2026",
      category: "membership",
      url: "#",
    ...
    {
      id: "cr-document-golf-courses",
      title: "Golf Course Guide — Club Renaissance · 18 holes",
      category: "golf",
      url: "#",
    ...
    {
      id: "cr-document-real-estate",
      title: "Featured Homes — Club Renaissance Realty Listings",
      category: "real_estate",
      url: "#",
      uploadedBy: "Membership · Club Renaissance Realty",
      daysAgo: 4,
    },
    {
      id: "cr-document-governance",
      title: "Board of Governors — Meeting Summary",
      category: "legal",
      url: "#",
      uploadedBy: "Drew Hoffman · Board",
      daysAgo: 20,
    },
  ] as const;
  ...
  const groups = [
    {
      ...
      description:
        "18 holes — par-72 ClubLink course (links front / conservation back). Pairings, leagues, and member tournaments.",
    ...
    {
      id: "cr-group-newcomers",
      name: "New Member Welcome",
      description: "Welcome notes, ride shares, and recommendations around Pebble Beach Blvd and the club.",
...
async function seedMessages() {
  ...
  const michael = { email: "golf@clubrenaissance.com", name: "Mike Torres" };
  const laura = { email: "golf.assistant@clubrenaissance.com", name: "Jamie Chen" };
  const sophia = { email: "spa@clubrenaissance.com", name: "Nina Patel" };
  const megan = { email: "events@clubrenaissance.com", name: "Morgan Blake" };
  const dining = { email: DINING_EMAIL, name: "Dining Reservations" };
  const elena = { email: PM_EMAIL, name: PM_NAME };
  const patricia = { email: MEMBERSHIP_EMAIL, name: "Alexis Macon" };
  const frederick = { email: PM_EMAIL, name: "Alexis Macon" };
  ...
  const threads: Array<{
    ...
    {
      id: "cr-chat-claire-patricia",
      createdBy: patricia.email,
      participants: [claire, patricia],
      messages: [
        {
          author: patricia,
          body: "Taylor — 2201 South Pebble Beach Blvd is still active. Want the updated listing packet with golf membership notes?",
          hoursAgo: 22,
        },
        {
          author: claire,
        ...
        {
          author: patricia,
          body: "Packet sent. Call Club Renaissance Realty if you need anything before showings.",
          hoursAgo: 19,
        },
      ],
    },
    {
      id: "cr-chat-frederick-claire",
...
export async function ensureClubRenaissanceDemoSeeded(): Promise<void> {
  if (!process.env.DATABASE_URL) return;
  if (!isDemoSeedAllowed()) return;

  await prisma.community.upsert({
    where: { id: CLUB_RENAISSANCE_COMMUNITY_ID },
    create: {
      id: CLUB_RENAISSANCE_COMMUNITY_ID,
      ...
      inviteCode: "club-renaissance-demo",
    },
    update: {
      name: "Club Renaissance Golf Club",
      location: "Sun City Center, FL",
  ...
  for (const user of [
    { id: "u-cr-member", email: MEMBER_EMAIL, role: "member", name: MEMBER_NAME },
    { id: "u-cr-member-social", email: SOCIAL_EMAIL, role: "member", name: SOCIAL_NAME },
    { id: "u-cr-pm", email: PM_EMAIL, role: "pm", name: PM_NAME },
    { id: "u-cr-board", email: BOARD_EMAIL, role: "board", name: BOARD_NAME },
  ] as const) {
  ...
  for (const profile of [
    {
      email: MEMBER_EMAIL,
      membershipTier: "golf",
      unit: "2201 South Pebble Beach Blvd",
      householdAddress: "2201 South Pebble Beach Blvd, Sun City Center, FL 33573",
    },
    {
      email: SOCIAL_EMAIL,
      membershipTier: "social",
      unit: "2215 South Pebble Beach Blvd",
      householdAddress: "2215 South Pebble Beach Blvd, Sun City Center, FL 33573",
    },
  ] as const) {
  ...
  await ensureMembershipTiersSeeded(CLUB_RENAISSANCE_COMMUNITY_ID);
  await seedAmenities();
...
export async function ensureClubRenaissanceDemoServiceRequests(): Promise<void> {
  if (!process.env.DATABASE_URL) return;
  if (!isDemoSeedAllowed()) return;
  await seedServiceRequests();
}
...
export async function ensureClubRenaissanceDemoApparel(): Promise<void> {
  if (!process.env.DATABASE_URL) return;
  if (!isDemoSeedAllowed()) return;
  await seedApparel();
}
...
export async function ensureClubRenaissanceDemoMarketplace(): Promise<void> {
  if (!process.env.DATABASE_URL) return;
  if (!isDemoSeedAllowed()) return;
  await seedMarketplace();
}
...
export async function ensureClubRenaissanceDemoBlog(): Promise<void> {
  if (!process.env.DATABASE_URL) return;
  if (!isDemoSeedAllowed()) return;
  await seedBlog();
}
...
export async function ensureClubRenaissanceDemoNewsletters(): Promise<void> {
  if (!process.env.DATABASE_URL) return;
  if (!isDemoSeedAllowed()) return;
  await seedNewsletters();
}
...
export async function ensureClubRenaissanceDemoGallery(): Promise<void> {
  if (!process.env.DATABASE_URL) return;
  if (!isDemoSeedAllowed()) return;
  await seedGallery();
}
...
export async function ensureClubRenaissanceDemoPropertiesAndRealEstate(): Promise<void> {
  if (!process.env.DATABASE_URL) return;
  if (!isDemoSeedAllowed()) return;
  await seedProperties();
  await seedRealEstate();
...
async function seedServiceRequests() {
  const rows = [
    ...
    },
    {
      ...
      memberName: MEMBER_NAME,
      unit: "2201 South Pebble Beach Blvd",
      title: "Irrigation overspray on Pebble Beach driveway",
      category: "Landscaping",
      description:
        "Common-area heads near 2200 South Pebble Beach soak the paver driveway every morning around 5:30am.",
      status: "in_progress",
      daysAgo: 4,
    },
    {
...
async function seedApparel() {
  const proShop = "Club Renaissance Pro Shop";
  const apparel = [
    {
      id: "cr-apparel-polo-navy",
      name: "Club Polo — Navy",
      description: "Performance pique polo with embroidered Club Renaissance crest.",
      price: 58,
      category: "Polo",
      sizesJson: '["S","M","L","XL","XXL"]',
      imageUrl: "/brand/apparel/cr-apparel-polo-navy.png",
    },
    {
      id: "cr-apparel-ladies-polo",
      name: "Ladies Sleeveless Polo — White",
      description: "Moisture-wicking sleeveless polo with club crest — ideal for warm Club Renaissance rounds.",
      price: 52,
      category: "Polo",
      sizesJson: '["XS","S","M","L","XL"]',
      imageUrl: "/brand/apparel/cr-apparel-ladies-polo.png",
    },
    {
      id: "cr-apparel-quarter-zip",
      name: "Member Quarter-Zip — Heather Grey",
      description: "Lightweight layer for cool Club Renaissance mornings on the championship course.",
      price: 78,
      category: "Outerwear",
      sizesJson: '["S","M","L","XL","XXL"]',
      imageUrl: "/brand/apparel/cr-apparel-quarter-zip.png",
    },
    {
      id: "cr-apparel-cap",
      name: "Performance Cap — Navy",
      description: "Structured adjustable cap with embroidered Club Renaissance crest.",
      price: 32,
      category: "Accessories",
      sizesJson: '["One Size"]',
      imageUrl: "/brand/apparel/cr-apparel-cap-navy.png",
    },
    {
      id: "cr-apparel-visor",
      ...
      category: "Accessories",
      sizesJson: '["One Size"]',
      imageUrl: "/brand/apparel/cr-apparel-visor-black.png",
    },
    {
      id: "cr-apparel-towel",
      ...
      category: "Accessories",
      sizesJson: '["One Size"]',
      imageUrl: "/brand/apparel/cr-apparel-towel.png",
    },
  ] as const;
    ...
    await prisma.apparelOrder.create({
      data: {
        ...
        itemsJson: JSON.stringify([
          {
            productId: "cr-apparel-polo-navy",
            name: "Club Polo — Navy",
            size: "M",
            qty: 1,
            unitPrice: 58,
...
async function seedMarketplace() {
  const listings = [
    {
      id: "cr-marketplace-golf-balls",
      title: "Titleist Pro V1 Dozen",
      description: "Unopened dozen — switching to Left Dash. Pickup on Club Renaissance after golf.",
      price: 42,
      category: "Golf",
      seller: MEMBER_NAME,
      unit: "2201 South Pebble Beach Blvd",
    ...
    {
      id: "cr-marketplace-patio",
      title: "Lanai Dining Set, 6 Chairs",
      description: "Weather-resistant table and six chairs. Local pickup on Pebble Beach Blvd only.",
      price: 295,
      category: "Home",
      seller: SOCIAL_NAME,
      unit: "2215 South Pebble Beach Blvd",
    ...
    {
      id: "cr-marketplace-callaway-junior",
...
async function seedBlog() {
  const posts = [
    {
      id: "cr-blog-five-courses",
      title: "Playing the championship course this season",
      excerpt:
        "Director of Golf Mike Torres shares tips for Club Renaissance's 18 holes.",
      body: "Club Renaissance members enjoy 18 holes — par-72 ClubLink golf, links-style front nine and conservation back nine (4,651–6,701 yards). Book early mornings for the coolest conditions and ask the pro shop about member events.",
      author: "Mike Torres, PGA",
      category: "Golf",
      daysAgo: 1,
    },
    {
      id: "cr-blog-breezeway",
      ...
      author: "Club Renaissance Dining",
      category: "Dining",
      daysAgo: 3,
    },
    {
      id: "cr-blog-golf-community",
      title: "18 holes, one thriving golf community",
      excerpt:
        "Spa recovery evenings and short-game clinics on the practice greens.",
      body: "With 18 holes across the championship course — ClubLink par-72 golf — Club Renaissance runs member events so everyone meets more members. Book a tee time in the app, arrive early for the practice putting and chipping, and stay for Clubhouse Bar afterward.",
      author: "Jamie Chen",
      category: "Golf",
      daysAgo: 5,
    },
    {
      id: "cr-blog-golf-tips",
      title: "Practice range & greens — warm-up tips",
      excerpt: "Get the most from Club Renaissance's practice facilities before you tee off.",
    ...
    {
      id: "cr-blog-welcome",
      title: "Welcome to Club Renaissance Golf Club",
      excerpt:
  ...
  const comments = [
    {
      id: "cr-blog-comment-golf-1",
      postId: "cr-blog-five-courses",
      author: MEMBER_NAME,
      body: "The course at dawn is unbeatable — thanks for the tips, Mike!",
    },
    {
      id: "cr-blog-comment-golf-2",
      postId: "cr-blog-five-courses",
      author: SOCIAL_NAME,
      body: "Championship Course was in perfect shape last weekend.",
    },
    {
      id: "cr-blog-comment-breezeway-1",
      postId: "cr-blog-breezeway",
      author: MEMBER_NAME,
      body: "Clubhouse Bar after golf is our Saturday ritual now.",
    },
    {
      id: "cr-blog-comment-community-1",
      postId: "cr-blog-golf-community",
      author: SOCIAL_NAME,
...
async function seedNewsletters() {
  const newsletters = [
    {
      id: "cr-newsletter-july-2026",
      title: "Club Renaissance Golf Club Summer Update — July 2026",
      summary:
        "the championship course in peak condition, lounge socials, and July calendar highlights.",
      body: [
        "Members,",
        "",
        "Summer is in full swing at Club Renaissance Golf Club. Our 18 holes — par-72 ClubLink course, links front / conservation back (4,651–6,701 yards) — are in excellent condition. Early tee times remain the coolest window for 18 holes.",
        "",
        "This month:",
        ...
        "",
        "Questions: Membership · (813) 633-1015 · 2121 South Pebble Beach Blvd, Sun City Center, FL 33573 · membership@clubrenaissance.com · https://clubrenaissance.clublink.com/",
        "",
        "— Alexis Macon",
        "General Manager",
      ].join("\n"),
    ...
    },
    {
      ...
      body: [
        ...
        "",
        "Pro Shop: Crest polos, caps, and towels stocked — order through Club Apparel in the app · (813) 633-1015.",
        "",
        "— Golf Shop",
      ].join("\n"),
      daysAgo: 8,
    ...
    {
      id: "cr-newsletter-dining",
      title: "Dining at Club Renaissance — Midsummer Menus",
      summary:
      ...
      body: [
        ...
        "",
        "— Club Renaissance Dining",
        "dining@clubrenaissance.com",
      ].join("\n"),
      daysAgo: 14,
    },
    {
      id: "cr-newsletter-membership",
      title: "Membership Notes & Community Spotlight",
      summary:
        "Guest passes, directory updates, Club Renaissance Realty, and connecting in the app.",
      body: [
        "Members,",
        "",
        "Welcome to our newest Club Renaissance neighbors. Use Directory, Groups, Marketplace, and Documents in the app to settle in. Guest pass requests can be submitted as Service Requests or through Membership.",
        "",
        "Club Renaissance does not require any minimum spending at the club. We offer a wide variety of dining experiences, frequent menu changes, and social events so members choose to dine with us.",
        "",
        "For Membership and real-estate questions, contact Membership at membership@clubrenaissance.com · (813) 633-1015 · 2121 South Pebble Beach Blvd, Sun City Center, FL 33573.",
        "",
        "Thank you for making Club Renaissance Golf Club a vibrant member community.",
        "",
        "— Club Administration · Alexis Macon, General Manager",
      ].join("\n"),
      daysAgo: 21,
    },
  ] as const;
...
async function seedGallery() {
  const images = [
    ...
    {
      id: "cr-gallery-dining",
      title: "Clubhouse Restaurant",
      category: "Dining",
      url: brandAssets.featuredDining,
      uploadedBy: "Club Renaissance Dining",
      daysAgo: 7,
    },
  ] as const;
...
async function seedProperties() {
  const properties = [
    {
      id: "cr-property-claire-primary",
      userEmail: MEMBER_EMAIL,
      address: "2201 South Pebble Beach Blvd, Sun City Center, FL 33573",
      type: "Primary residence",
      owner: true,
    },
    {
      id: "cr-property-claire-guest",
      userEmail: MEMBER_EMAIL,
      address: "2301 South Pebble Beach Blvd, Sun City Center, FL 33573",
      type: "Investment property",
      owner: true,
    },
    {
      id: "cr-property-robert-primary",
      userEmail: SOCIAL_EMAIL,
      address: "2215 South Pebble Beach Blvd, Sun City Center, FL 33573",
      type: "Primary residence",
      owner: true,
    },
  ] as const;
...
async function seedRealEstate() {
  const patriciaEmail = "membership@clubrenaissance.com";
  const listings = [
    {
      id: "cr-real-estate-bay-harbor",
      memberEmail: patriciaEmail,
      title: "Club Renaissance Estate with Lake Views",
      description:
        "Updated four-bedroom estate with lanai, pool, and golf cart garage. Course views and easy access to the Championship Course. Listed with Membership · membership@clubrenaissance.com.",
      type: "sale",
      price: 1895000,
      beds: 4,
      baths: 3.5,
      sqft: 3420,
      unit: "2180 South Pebble Beach Blvd",
      color: "from-sky-600 to-teal-800",
      images: [brandAssets.amenityLodging, brandAssets.galleryClubhouseTerrace],
      daysAgo: 2,
    },
    {
      id: "cr-real-estate-country-club",
      memberEmail: patriciaEmail,
      title: "Pebble Beach Villa",
      description:
    ...
    {
      id: "cr-real-estate-creekside-rent",
      memberEmail: patriciaEmail,
      title: "Furnished Seasonal Rental — Club Renaissance Court",
      description:
