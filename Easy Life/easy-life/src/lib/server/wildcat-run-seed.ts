...
/**
 * Wildcat Run Golf & Country Club — Estero, FL demo tenant.
 * 20300 Country Club Dr, Estero, FL 33928 · (239) 947-6066 · (239) 495-3031
 * member.demo@wildcatruncc.com · Private equity golf club
 ...
 */
export const WILDCAT_RUN_COMMUNITY_ID = "wildcat-run";
const MEMBER_EMAIL = "member.demo@wildcatruncc.com";
const MEMBER_NAME = "Jordan Blake";
const SOCIAL_EMAIL = "member.social@wildcatruncc.com";
const SOCIAL_NAME = "Casey Wells";
const PM_EMAIL = "pm.demo@wildcatruncc.com";
const PM_NAME = "Alex Morgan";
const BOARD_EMAIL = "board.demo@wildcatruncc.com";
const BOARD_NAME = "Pat Rivera";
const CLUB_PHONE = "(239) 947-6066";
const PRO_SHOP_PHONE = "(239) 495-3031";
const DINING_EMAIL = "dining@wildcatruncc.com";
const MEMBERSHIP_EMAIL = "Membership@wildcatruncc.com";
...
const amenities: AmenitySeed[] = [
  {
    ...
    description:
      "18-hole championship golf course — part of the private equity ownership in Estero.",
    kind: "golf_course",
    unitCount: 8,
    holes: 18,
    hoursJson: golfHours,
  ...
  {
    id: "wr-amenity-clubhouse",
    name: "Clubhouse",
    description:
      "Main clubhouse for golf, casual and fine dining, banquet, spa, fitness, and member socials — private equity golf club in Estero.",
    kind: "facility",
    unitCount: 1,
    holes: null,
    hoursJson: clubhouseHours,
...
const staff = [
  ...
  },
  {
    ...
    department: "Golf",
    email: "golf.assistant@wildcatruncc.com",
    phone: PRO_SHOP_PHONE,
    category: "golf_pro",
    sortOrder: 11,
  },
  {
    ...
    email: "superintendent@wildcatruncc.com",
    phone: CLUB_PHONE,
    category: "golf_pro",
    sortOrder: 12,
  },
...
const menuItems: Array<{ id: string; name: string; price: number; category: string }> = [
  { id: "wr-menu-b-omelet", name: "Clubhouse Omelet", price: 14, category: "Casual Dining · Breakfast" },
  { id: "wr-menu-b-benedict", name: "Eggs Benedict", price: 16, category: "Casual Dining · Breakfast" },
  { id: "wr-menu-b-fruit", name: "Fresh Fruit Plate", price: 11, category: "Casual Dining · Breakfast" },
  { id: "wr-menu-l-burger", name: "Wildcat Burger", price: 17, category: "Casual Dining · Lunch" },
  { id: "wr-menu-l-fish", name: "Grouper Sandwich", price: 19, category: "Casual Dining · Lunch" },
  { id: "wr-menu-l-caesar", name: "Classic Caesar Salad", price: 13, category: "Casual Dining · Lunch" },
  { id: "wr-menu-l-club", name: "Club Sandwich", price: 15, category: "Casual Dining · Lunch" },
  { id: "wr-menu-d-salmon", name: "Pan-Seared Salmon", price: 32, category: "Casual Dining · Dinner" },
  { id: "wr-menu-d-filet", name: "Filet Mignon", price: 48, category: "Casual Dining · Dinner" },
  { id: "wr-menu-d-chicken", name: "Herb Roasted Chicken", price: 28, category: "Casual Dining · Dinner" },
  { id: "wr-menu-d-cake", name: "Key Lime Tart", price: 10, category: "Casual Dining · Desserts" },
  { id: "wr-menu-f-filet", name: "Prime Filet Mignon", price: 54, category: "Fine Dining · Dinner" },
  { id: "wr-menu-f-lobster", name: "Butter-Poached Lobster", price: 58, category: "Fine Dining · Dinner" },
  { id: "wr-menu-f-risotto", name: "Wild Mushroom Risotto", price: 32, category: "Fine Dining · Dinner" },
  { id: "wr-menu-bar-wrap", name: "Turkey Avocado Wrap", price: 14, category: "Grill & Bar · Small Plates" },
  { id: "wr-menu-bar-wings", name: "Club Wings", price: 15, category: "Grill & Bar · Small Plates" },
  { id: "wr-menu-bar-flatbread", name: "Margherita Flatbread", price: 14, category: "Grill & Bar · Small Plates" },
  { id: "wr-menu-bar-iced", name: "Fresh-Brewed Iced Tea", price: 4, category: "Grill & Bar · Beverages" },
  { id: "wr-menu-bar-margarita", name: "Estero Margarita", price: 12, category: "Grill & Bar · Cocktails" },
];
...
async function seedAmenities() {
  for (const amenity of amenities) {
    ...
    await prisma.amenity.upsert({
      ...
      create: {
        id: amenity.id,
        communityId: WILDCAT_RUN_COMMUNITY_ID,
        name: amenity.name,
...
async function seedDining() {
  await prisma.provider.upsert({
    where: { id: "wr-provider-dining" },
    create: {
      id: "wr-provider-dining",
      communityId: WILDCAT_RUN_COMMUNITY_ID,
      name: "Wildcat Run Dining",
      category: "Dining",
      type: "service",
      rating: 4.9,
      description:
...
const nearbyVendors = [
  {
    ...
    category: "Lawn Care",
    rating: 4.8,
    email: "lawn@wildcatruncc.com",
    phone: "(239) 555-5101",
    description:
      "Weekly mowing, edging, and seasonal plantings for Wildcat Run homes off Country Club Dr",
  },
  {
    id: "wr-vendor-pool",
    ...
    category: "Pool",
    rating: 4.7,
    email: "pool@wildcatruncc.com",
    phone: "(239) 555-5102",
    description:
      "Residential pool chemistry, weekly cleaning, and equipment service for Wildcat Run estates.",
  },
  {
    id: "wr-vendor-clean",
    name: "Country Club Dr Cleaning",
    category: "Cleaning",
    rating: 4.9,
    email: "cleaning@wildcatruncc.com",
    phone: "(239) 555-5103",
    description:
      "Housekeeping and deep cleans for villas and single-family homes in Wildcat Run Golf & Country Club.",
  },
  {
    id: "wr-vendor-hvac",
  ...
  },
  {
    ...
    category: "Plumbing",
    rating: 4.5,
    email: "plumbing@wildcatruncc.com",
    phone: "(239) 555-5105",
    description:
      "Same-day plumbing, fixture installs, and water heater service for Wildcat Run members.",
  },
  {
    id: "wr-vendor-windows",
    name: "Estero Window Cleaning",
    category: "Window Cleaning",
    rating: 4.7,
    email: "windows@wildcatruncc.com",
    phone: "(239) 555-5106",
    description:
  ...
  },
  {
    ...
    rating: 4.6,
    email: "pest@wildcatruncc.com",
    phone: "(239) 555-5107",
    description:
      "Quarterly pest control and seasonal mosquito treatments for Wildcat Run properties.",
  },
  {
    id: "wr-vendor-handyman",
    name: "Estero Handyman Co.",
    category: "Handyman",
    rating: 4.8,
    email: "handyman@wildcatruncc.com",
    phone: "(239) 555-5108",
    description:
  ...
  },
  {
    ...
    category: "Painting",
    rating: 4.5,
    email: "paint@wildcatruncc.com",
    phone: "(239) 555-5109",
    description:
      "Interior and exterior painting for villas and estate residences throughout Wildcat Run.",
  },
] as const;
...
async function seedEventsAndBookings() {
  ...
  for (const event of events) {
    await prisma.communityEvent.upsert({
      where: { id: event.id },
      create: { ...event, communityId: WILDCAT_RUN_COMMUNITY_ID, createdBy: "Wildcat Run Golf & Country Club" },
      update: event,
    });
  }
  ...
  const bookings = [
    ...
    {
      id: "wr-booking-dining",
      amenityId: "wr-amenity-dining-grill",
      unitNumber: 1,
...
async function seedEngagement() {
  ...
  for (const a of announcements) {
    await prisma.announcement.upsert({
      where: { id: a.id },
      create: { ...a, communityId: WILDCAT_RUN_COMMUNITY_ID },
      update: {
        title: a.title,
        body: a.body,
        author: a.author,
...
async function seedDocuments() {
  const documents = [
    {
      id: "wr-document-club-guide",
      title: "Wildcat Run Golf & Country Club — Member Guide 2026",
      category: "membership",
      url: "#",
    ...
    {
      id: "wr-document-real-estate",
      title: "Featured Homes — Wildcat Run Realty Listings",
      category: "real_estate",
      url: "#",
      uploadedBy: "Membership · Wildcat Run Realty",
      daysAgo: 4,
    },
    {
      id: "wr-document-governance",
...
async function seedGroups() {
  const groups = [
    ...
    {
      id: "wr-group-newcomers",
      name: "New Member Welcome",
      description: "Welcome notes, ride shares, and recommendations around Country Club Dr and the club.",
...
async function seedMessages() {
  ...
  const michael = { email: "golf@wildcatruncc.com", name: "Mike Torres" };
  const laura = { email: "golf.assistant@wildcatruncc.com", name: "Jamie Chen" };
  const sophia = { email: "spa@wildcatruncc.com", name: "Nina Patel" };
  const megan = { email: "events@wildcatruncc.com", name: "Morgan Blake" };
  ...
  const threads: Array<{
    ...
    {
      id: "wr-chat-claire-patricia",
      createdBy: patricia.email,
      participants: [claire, patricia],
      messages: [
        {
          author: patricia,
          body: "Taylor — 20300 Country Club Dr is still active. Want the updated listing packet with golf membership notes?",
          hoursAgo: 22,
        },
        {
          author: claire,
        ...
        {
          author: patricia,
          body: "Packet sent. Call Wildcat Run Realty if you need anything before showings.",
          hoursAgo: 19,
        },
      ],
    },
    {
      id: "wr-chat-frederick-claire",
...
export async function ensureWildcatRunDemoSeeded(): Promise<void> {
  if (!process.env.DATABASE_URL) return;
  if (!isDemoSeedAllowed()) return;

  await prisma.community.upsert({
    where: { id: WILDCAT_RUN_COMMUNITY_ID },
    create: {
      id: WILDCAT_RUN_COMMUNITY_ID,
  ...
  for (const user of [
    { id: "u-wr-member", email: MEMBER_EMAIL, role: "member", name: MEMBER_NAME },
    { id: "u-wr-member-social", email: SOCIAL_EMAIL, role: "member", name: SOCIAL_NAME },
    { id: "u-wr-pm", email: PM_EMAIL, role: "pm", name: PM_NAME },
    { id: "u-wr-board", email: BOARD_EMAIL, role: "board", name: BOARD_NAME },
  ] as const) {
  ...
  for (const profile of [
    {
      email: MEMBER_EMAIL,
      membershipTier: "golf",
      unit: "20300 Country Club Dr",
      householdAddress: "20300 Country Club Dr, Estero, FL 33928",
    },
    {
      email: SOCIAL_EMAIL,
      membershipTier: "social",
      unit: "20301 Country Club Dr",
      householdAddress: "20301 Country Club Dr, Estero, FL 33928",
    },
  ] as const) {
  ...
  await ensureMembershipTiersSeeded(WILDCAT_RUN_COMMUNITY_ID);
  await seedAmenities();
...
export async function ensureWildcatRunDemoServiceRequests(): Promise<void> {
  if (!process.env.DATABASE_URL) return;
  if (!isDemoSeedAllowed()) return;
  await seedServiceRequests();
}
...
export async function ensureWildcatRunDemoApparel(): Promise<void> {
  if (!process.env.DATABASE_URL) return;
  if (!isDemoSeedAllowed()) return;
  await seedApparel();
}
...
export async function ensureWildcatRunDemoMarketplace(): Promise<void> {
  if (!process.env.DATABASE_URL) return;
  if (!isDemoSeedAllowed()) return;
  await seedMarketplace();
}
...
export async function ensureWildcatRunDemoBlog(): Promise<void> {
  if (!process.env.DATABASE_URL) return;
  if (!isDemoSeedAllowed()) return;
  await seedBlog();
}
...
export async function ensureWildcatRunDemoNewsletters(): Promise<void> {
  if (!process.env.DATABASE_URL) return;
  if (!isDemoSeedAllowed()) return;
  await seedNewsletters();
}
...
export async function ensureWildcatRunDemoGallery(): Promise<void> {
  if (!process.env.DATABASE_URL) return;
  if (!isDemoSeedAllowed()) return;
  await seedGallery();
}
...
export async function ensureWildcatRunDemoPropertiesAndRealEstate(): Promise<void> {
  if (!process.env.DATABASE_URL) return;
  if (!isDemoSeedAllowed()) return;
  await seedProperties();
  await seedRealEstate();
...
async function seedServiceRequests() {
  const rows = [
    ...
    },
    {
      ...
      memberName: MEMBER_NAME,
      unit: "20300 Country Club Dr",
      title: "Irrigation overspray on Country Club Dr driveway",
      category: "Landscaping",
      description:
        "Common-area heads near 20300 Country Club Dr soak the paver driveway every morning around 5:30am.",
      status: "in_progress",
      daysAgo: 4,
    },
    {
...
async function seedApparel() {
  const proShop = "Wildcat Run Pro Shop";
  const apparel = [
    {
      id: "wr-apparel-polo-navy",
      name: "Club Polo — Navy",
      description: "Performance pique polo with embroidered Wildcat Run crest.",
      price: 58,
      category: "Polo",
      sizesJson: '["S","M","L","XL","XXL"]',
      imageUrl: "/brand/apparel/wr-apparel-polo-navy.png",
    },
    {
      id: "wr-apparel-ladies-polo",
      name: "Ladies Sleeveless Polo — White",
      description: "Moisture-wicking sleeveless polo with club crest — ideal for warm Wildcat Run rounds.",
      price: 52,
      category: "Polo",
      sizesJson: '["XS","S","M","L","XL"]',
      imageUrl: "/brand/apparel/wr-apparel-ladies-polo.png",
    },
    {
      id: "wr-apparel-quarter-zip",
      name: "Member Quarter-Zip — Heather Grey",
      description: "Lightweight layer for cool Wildcat Run mornings on the championship course.",
      price: 78,
      category: "Outerwear",
      sizesJson: '["S","M","L","XL","XXL"]',
      imageUrl: "/brand/apparel/wr-apparel-quarter-zip.png",
    },
    {
      id: "wr-apparel-cap",
      name: "Performance Cap — Navy",
      description: "Structured adjustable cap with embroidered Wildcat Run crest.",
      price: 32,
      category: "Accessories",
      sizesJson: '["One Size"]',
      imageUrl: "/brand/apparel/wr-apparel-cap-navy.png",
    },
    {
      id: "wr-apparel-visor",
      ...
      category: "Accessories",
      sizesJson: '["One Size"]',
      imageUrl: "/brand/apparel/wr-apparel-visor-black.png",
    },
    {
      id: "wr-apparel-towel",
      ...
      category: "Accessories",
      sizesJson: '["One Size"]',
      imageUrl: "/brand/apparel/wr-apparel-towel.png",
    },
  ] as const;
    ...
    await prisma.apparelOrder.create({
      data: {
        ...
        itemsJson: JSON.stringify([
          {
            productId: "wr-apparel-polo-navy",
            name: "Club Polo — Navy",
            size: "M",
            qty: 1,
            unitPrice: 58,
...
async function seedMarketplace() {
  const listings = [
    {
      id: "wr-marketplace-golf-balls",
      title: "Titleist Pro V1 Dozen",
      description: "Unopened dozen — switching to Left Dash. Pickup on Wildcat Run after golf.",
      price: 42,
      category: "Golf",
      seller: MEMBER_NAME,
      unit: "20300 Country Club Dr",
    ...
    {
      id: "wr-marketplace-patio",
      title: "Lanai Dining Set, 6 Chairs",
      description: "Weather-resistant table and six chairs. Local pickup on Country Club Dr only.",
      price: 295,
      category: "Home",
      seller: SOCIAL_NAME,
      unit: "20301 Country Club Dr",
    ...
    {
      id: "wr-marketplace-callaway-junior",
...
async function seedBlog() {
  const posts = [
    {
      id: "wr-blog-five-courses",
      title: "Playing the championship course this season",
      excerpt:
        "Director of Golf Mike Torres shares tips for Wildcat Run's 18 holes.",
      body: "Wildcat Run members enjoy 18 holes — 18-hole championship golf course. Book early mornings for the coolest conditions and ask the pro shop about member events.",
      author: "Mike Torres, PGA",
      category: "Golf",
      daysAgo: 1,
    },
    {
      id: "wr-blog-breezeway",
      ...
      author: "Wildcat Run Dining",
      category: "Dining",
      daysAgo: 3,
    },
    {
      id: "wr-blog-golf-community",
      title: "18 holes, one thriving golf community",
      excerpt:
        "Spa recovery evenings and short-game clinics on the practice greens.",
      body: "With 18 holes across the championship course — private equity championship golf — Wildcat Run runs member events so everyone meets more members. Book a tee time in the app, arrive early for the practice putting and chipping, and stay for Grill & Bar afterward.",
      author: "Jamie Chen",
      category: "Golf",
      daysAgo: 5,
    },
    {
      id: "wr-blog-golf-tips",
      title: "Practice range & greens — warm-up tips",
      excerpt: "Get the most from Wildcat Run's practice facilities before you tee off.",
    ...
    {
      id: "wr-blog-welcome",
      title: "Welcome to Wildcat Run Golf & Country Club",
      excerpt:
  ...
  const comments = [
    {
      id: "wr-blog-comment-golf-1",
      postId: "wr-blog-five-courses",
      author: MEMBER_NAME,
      body: "The course at dawn is unbeatable — thanks for the tips, Mike!",
    },
    {
      id: "wr-blog-comment-golf-2",
      postId: "wr-blog-five-courses",
      author: SOCIAL_NAME,
      body: "Championship Course was in perfect shape last weekend.",
    },
    {
      id: "wr-blog-comment-breezeway-1",
      postId: "wr-blog-breezeway",
      author: MEMBER_NAME,
      body: "Grill & Bar after golf is our Saturday ritual now.",
    },
    {
      id: "wr-blog-comment-community-1",
      postId: "wr-blog-golf-community",
      author: SOCIAL_NAME,
...
async function seedNewsletters() {
  const newsletters = [
    {
      id: "wr-newsletter-july-2026",
      title: "Wildcat Run Golf & Country Club Summer Update — July 2026",
      summary:
        "the championship course in peak condition, lounge socials, and July calendar highlights.",
      body: [
        "Members,",
        "",
        "Summer is in full swing at Wildcat Run Golf & Country Club. Our 18 holes — 18-hole championship course, private equity championship golf — are in excellent condition. Early tee times remain the coolest window for 18 holes.",
        "",
        "This month:",
        ...
        "",
        "Questions: Membership · (239) 495-2278 · 20300 Country Club Dr, Estero, FL 33928 · Membership@wildcatruncc.com · https://www.wildcatruncc.com/",
        "",
        "— Alex Morgan",
        "General Manager",
      ].join("\n"),
    ...
    {
      id: "wr-newsletter-dining",
      title: "Dining at Wildcat Run — Midsummer Menus",
      summary:
      ...
      body: [
        ...
        "",
        "— Wildcat Run Dining",
        "dining@wildcatruncc.com",
      ].join("\n"),
      daysAgo: 14,
    },
    {
      id: "wr-newsletter-membership",
      title: "Membership Notes & Community Spotlight",
      summary:
        "Guest passes, directory updates, Wildcat Run Realty, and connecting in the app.",
      body: [
        "Members,",
        "",
        "Welcome to our newest Wildcat Run neighbors. Use Directory, Groups, Marketplace, and Documents in the app to settle in. Guest pass requests can be submitted as Service Requests or through Membership.",
        "",
        "Wildcat Run does not require any minimum spending at the club. We offer a wide variety of dining experiences, frequent menu changes, and social events so members choose to dine with us.",
        "",
        "For Membership and real-estate questions, contact Membership at Membership@wildcatruncc.com · (239) 495-2278 · 20300 Country Club Dr, Estero, FL 33928.",
        "",
        "Thank you for making Wildcat Run Golf & Country Club a vibrant member community.",
        "",
...
async function seedGallery() {
  const images = [
    ...
    {
      id: "wr-gallery-dining",
      title: "Casual Dining",
      category: "Dining",
      url: brandAssets.featuredDining,
      uploadedBy: "Wildcat Run Dining",
      daysAgo: 7,
    },
  ] as const;
...
async function seedProperties() {
  const properties = [
    {
      id: "wr-property-claire-primary",
      userEmail: MEMBER_EMAIL,
      address: "20300 Country Club Dr, Estero, FL 33928",
      type: "Primary residence",
      owner: true,
    },
    {
      id: "wr-property-claire-guest",
      userEmail: MEMBER_EMAIL,
      address: "20500 Country Club Dr, Estero, FL 33928",
      type: "Investment property",
      owner: true,
    },
    {
      id: "wr-property-robert-primary",
      userEmail: SOCIAL_EMAIL,
      address: "20301 Country Club Dr, Estero, FL 33928",
      type: "Primary residence",
      owner: true,
    },
  ] as const;
...
async function seedRealEstate() {
  const patriciaEmail = "Membership@wildcatruncc.com";
  const listings = [
    {
      id: "wr-real-estate-bay-harbor",
      memberEmail: patriciaEmail,
      title: "Wildcat Run Estate with Lake Views",
      description:
        "Updated four-bedroom estate with lanai, pool, and golf cart garage. Course views and easy access to the Championship Course. Listed with Membership · Membership@wildcatruncc.com.",
      type: "sale",
      price: 1895000,
      beds: 4,
      baths: 3.5,
      sqft: 3420,
      unit: "20400 Country Club Dr",
      color: "from-sky-600 to-teal-800",
      images: [brandAssets.amenityLodging, brandAssets.galleryClubhouseTerrace],
      daysAgo: 2,
    },
    {
      id: "wr-real-estate-country-club",
      memberEmail: patriciaEmail,
      title: "Country Club Dr Villa",
      description:
    ...
    {
      id: "wr-real-estate-creekside-rent",
      memberEmail: patriciaEmail,
      title: "Furnished Seasonal Rental — Country Club Dr",
      description:
