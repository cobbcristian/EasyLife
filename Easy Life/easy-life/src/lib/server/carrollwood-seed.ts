...
/**
 * Carrollwood Country Club — Tampa, FL demo tenant.
 * 13903 Clubhouse Drive, Tampa, FL 33618 — Main/To Go (813) 961-1381 — Golf Shop (813) 961-1369
 * Tennis & Aquatics (813) 961-1368 — member.demo@carrollwoodcc.com — https://www.carrollwoodcc.com
 * Tampa's premier private club; 27 holes with Champion Ultradwarf greens; 8 Har-Tru tennis with
 * stadium lighting; fitness; junior Olympic heated pool; casual and fine dining.
 */
export const CARROLLWOOD_COMMUNITY_ID = "carrollwood";
const MEMBER_EMAIL = "member.demo@carrollwoodcc.com";
const MEMBER_NAME = "Jordan Blake";
const SOCIAL_EMAIL = "member.social@carrollwoodcc.com";
const SOCIAL_NAME = "Casey Wells";
const PM_EMAIL = "pm.demo@carrollwoodcc.com";
const PM_NAME = "Alex Morgan";
const BOARD_EMAIL = "board.demo@carrollwoodcc.com";
const BOARD_NAME = "Pat Rivera";
const CLUB_PHONE = "(813) 961-1381";
const PRO_SHOP_PHONE = "(813) 961-1369";
const TENNIS_AQUATICS_PHONE = "(813) 961-1368";
const DINING_EMAIL = "dining@carrollwoodcc.com";
const MEMBERSHIP_EMAIL = "membership@carrollwoodcc.com";
...
const amenities: AmenitySeed[] = [
  {
    id: "cw-amenity-golf",
    name: "27-Hole Championship Golf",
    description:
      "27 holes of private championship golf on Champion Ultradwarf greens — Tampa's premier private club course experience.",
    kind: "golf_course",
    unitCount: 10,
    holes: 27,
    hoursJson: golfHours,
  },
  {
    ...
    description:
      "Full practice facility with driving range, putting greens, and short-game area before your round.",
    kind: "driving_range",
    unitCount: 16,
    holes: null,
    hoursJson: golfHours,
  ...
  {
    id: "cw-amenity-tennis",
    name: "Har-Tru Tennis Courts",
    description:
      "Eight Har-Tru tennis courts with stadium lighting, leagues, clinics, and private lessons.",
    kind: "court",
    unitCount: 8,
    holes: null,
    surface: "green_clay",
  ...
  {
    id: "cw-amenity-pool",
    name: "Junior Olympic Heated Pool",
    description:
      "Junior Olympic heated pool and aquatics deck for swim, lounge, and member socials.",
    kind: "pool",
    unitCount: 1,
    holes: null,
    hoursJson: poolHours,
  ...
  {
    id: "cw-amenity-dining-grill",
    name: "Casual Dining",
    description:
      "Casual clubhouse dining for breakfast, lunch, and dinner — post-round favorites and club classics.",
    kind: "restaurant",
    unitCount: 18,
    holes: null,
    hoursJson: grillHours,
  ...
  {
    id: "cw-amenity-dining-togo",
    name: "To Go",
    description:
      "Clubhouse To Go for member favorites — call (813) 961-1381 to order ahead.",
    kind: "restaurant",
    unitCount: 6,
    holes: null,
  ...
  {
    id: "cw-amenity-proshop",
    name: "Golf Shop",
    description:
      "Golf shop for tee times, apparel, and equipment — (813) 961-1369.",
    kind: "facility",
    unitCount: 1,
    holes: null,
  ...
  {
    id: "cw-amenity-clubhouse",
    name: "Clubhouse",
    description:
      "Main clubhouse at 13903 Clubhouse Drive — 27-hole golf, fine and casual dining, fitness, tennis, and aquatics.",
    kind: "facility",
    unitCount: 1,
    holes: null,
    hoursJson: clubhouseHours,
...
const staff = [
  ...
  },
  {
    ...
    department: "Golf",
    email: "golf.assistant@carrollwoodcc.com",
    phone: PRO_SHOP_PHONE,
    category: "golf_pro",
    sortOrder: 11,
  },
  {
    ...
    email: "superintendent@carrollwoodcc.com",
    phone: CLUB_PHONE,
    category: "golf_pro",
    sortOrder: 12,
  },
  {
    id: "cw-staff-aquatics",
    name: "Nina Patel",
    title: "Tennis & Aquatics Coordinator",
    department: "Tennis & Aquatics",
    email: "aquatics@carrollwoodcc.com",
    phone: CLUB_PHONE,
    category: "management",
    sortOrder: 20,
  },
  {
    ...
    department: "Events",
    email: "events@carrollwoodcc.com",
    phone: CLUB_PHONE,
    category: "management",
    sortOrder: 21,
  },
...
/** Casual Dining (B/L/D) and To Go menus. */
const menuItems: Array<{ id: string; name: string; price: number; category: string }> = [
  { id: "cw-menu-b-omelet", name: "Clubhouse Omelet", price: 14, category: "Casual Dining — Breakfast" },
  { id: "cw-menu-b-benedict", name: "Eggs Benedict", price: 16, category: "Casual Dining — Breakfast" },
  { id: "cw-menu-b-fruit", name: "Fresh Fruit Plate", price: 11, category: "Casual Dining — Breakfast" },
  { id: "cw-menu-l-burger", name: "Carrollwood Burger", price: 17, category: "Casual Dining — Lunch" },
  { id: "cw-menu-l-fish", name: "Grouper Sandwich", price: 19, category: "Casual Dining — Lunch" },
  { id: "cw-menu-l-caesar", name: "Classic Caesar Salad", price: 13, category: "Casual Dining — Lunch" },
  { id: "cw-menu-l-club", name: "Club Sandwich", price: 15, category: "Casual Dining — Lunch" },
  { id: "cw-menu-d-salmon", name: "Pan-Seared Salmon", price: 32, category: "Casual Dining — Dinner" },
  { id: "cw-menu-d-filet", name: "Filet Mignon", price: 48, category: "Casual Dining — Dinner" },
  { id: "cw-menu-d-chicken", name: "Herb Roasted Chicken", price: 28, category: "Casual Dining — Dinner" },
  { id: "cw-menu-d-cake", name: "Key Lime Tart", price: 10, category: "Casual Dining — Desserts" },
  { id: "cw-menu-f-filet", name: "Prime Filet Mignon", price: 54, category: "Fine Dining — Dinner" },
  { id: "cw-menu-f-lobster", name: "Butter-Poached Lobster", price: 58, category: "Fine Dining — Dinner" },
  { id: "cw-menu-f-risotto", name: "Wild Mushroom Risotto", price: 32, category: "Fine Dining — Dinner" },
  { id: "cw-menu-bar-wrap", name: "Turkey Avocado Wrap", price: 14, category: "To Go — Small Plates" },
  { id: "cw-menu-bar-wings", name: "Club Wings", price: 15, category: "To Go — Small Plates" },
  { id: "cw-menu-bar-flatbread", name: "Margherita Flatbread", price: 14, category: "To Go — Small Plates" },
  { id: "cw-menu-bar-iced", name: "Fresh-Brewed Iced Tea", price: 4, category: "To Go — Beverages" },
  { id: "cw-menu-bar-margarita", name: "Carrollwood Margarita", price: 12, category: "To Go — Cocktails" },
];
...
async function seedAmenities() {
  for (const amenity of amenities) {
    ...
    await prisma.amenity.upsert({
      ...
      create: {
        id: amenity.id,
        communityId: CARROLLWOOD_COMMUNITY_ID,
        name: amenity.name,
...
async function seedDining() {
  await prisma.provider.upsert({
    where: { id: "cw-provider-dining" },
    create: {
      id: "cw-provider-dining",
      communityId: CARROLLWOOD_COMMUNITY_ID,
      name: "Carrollwood Dining",
      category: "Dining",
      type: "service",
      rating: 4.9,
      description:
        "Casual Dining (breakfast, lunch, dinner) and To Go.",
      phone: CLUB_PHONE,
      email: DINING_EMAIL,
...
const nearbyVendors = [
  {
    id: "cw-vendor-lawn",
    name: "Carrollwood Lawn & Landscape",
    category: "Lawn Care",
    rating: 4.8,
    email: "lawn@carrollwoodcc.com",
    phone: "(813) 961-5101",
    description:
      "Weekly mowing, edging, and seasonal plantings for Carrollwood homes off Carrollwood Blvd",
  },
  {
    id: "cw-vendor-pool",
    name: "Carrollwood Home Care",
    category: "Pool",
    rating: 4.7,
    email: "pool@carrollwoodcc.com",
    phone: "(813) 961-5102",
    description:
      "Residential pool chemistry, weekly cleaning, and equipment service for Carrollwood estates.",
  },
  {
    id: "cw-vendor-clean",
    name: "Carrollwood Blvd Cleaning",
    category: "Cleaning",
    rating: 4.9,
    email: "cleaning@carrollwoodcc.com",
    phone: "(813) 961-5103",
    description:
      "Housekeeping and deep cleans for villas and single-family homes in Carrollwood Country Club.",
  },
  {
    id: "cw-vendor-hvac",
    name: "Carrollwood Climate HVAC",
    category: "HVAC",
    rating: 4.6,
    email: "hvac@carrollwoodcc.com",
    phone: "(813) 961-5104",
    description:
  ...
  {
    id: "cw-vendor-plumb",
    name: "Carrollwood Plumbing",
    category: "Plumbing",
    rating: 4.5,
    email: "plumbing@carrollwoodcc.com",
    phone: "(813) 961-5105",
    description:
      "Same-day plumbing, fixture installs, and water heater service for Carrollwood members.",
  },
  {
    id: "cw-vendor-windows",
    name: "Carrollwood Window Cleaning",
    category: "Window Cleaning",
    rating: 4.7,
    email: "windows@carrollwoodcc.com",
    phone: "(813) 961-5106",
    description:
  ...
  {
    id: "cw-vendor-pest",
    name: "Carrollwood Pest Pros",
    category: "Pest Control",
    rating: 4.6,
    email: "pest@carrollwoodcc.com",
    phone: "(813) 961-5107",
    description:
      "Quarterly pest control and seasonal mosquito treatments for Carrollwood properties.",
  },
  {
    id: "cw-vendor-handyman",
    name: "Carrollwood Handyman Co.",
    category: "Handyman",
    rating: 4.8,
    email: "handyman@carrollwoodcc.com",
    phone: "(813) 961-5108",
    description:
  ...
  },
  {
    ...
    category: "Painting",
    rating: 4.5,
    email: "paint@carrollwoodcc.com",
    phone: "(813) 961-5109",
    description:
      "Interior and exterior painting for villas and estate residences throughout Carrollwood.",
  },
] as const;
...
async function seedEventsAndBookings() {
  const events = [
    ...
    {
      id: "cw-event-member-social",
      title: "Member Twilight Social",
      description: "Twilight gathering at the To Go with small plates and course views.",
    ...
    {
      id: "cw-event-pool-social",
      title: "Pool & Aquatics Social",
      description: "Member pool and aquatics social — swim laps and lounge on the deck after afternoon rounds.",
      date: easternDateOffset(8),
      time: "16:00",
      location: "Junior Olympic Heated Pool",
      category: "social",
      isPromoted: true,
      capacity: 16,
      requirePayment: true,
  ...
  for (const event of events) {
    await prisma.communityEvent.upsert({
      where: { id: event.id },
      create: { ...event, communityId: CARROLLWOOD_COMMUNITY_ID, createdBy: "Carrollwood Country Club" },
      update: event,
    });
  }
  ...
  const bookings = [
    {
      id: "cw-booking-golf",
      amenityId: "cw-amenity-golf",
      unitNumber: 1,
      amenity: "27-Hole Championship Golf",
      date: easternDateOffset(2),
      startTime: "08:12",
      endTime: "12:30",
    },
    {
      id: "cw-booking-pool",
      amenityId: "cw-amenity-pool",
      unitNumber: 1,
      amenity: "Junior Olympic Heated Pool",
      date: easternDateOffset(1),
      startTime: "14:00",
      endTime: "15:00",
    },
    {
      id: "cw-booking-dining",
      amenityId: "cw-amenity-dining-grill",
      unitNumber: 1,
...
async function seedEngagement() {
  const announcements = [
    {
      id: "cw-announcement-golf",
      title: "Championship course in peak condition",
      body: "The championship course is in peak condition. Book tee times through the pro shop at (813) 961-1381 — early mornings recommended.",
      author: "Golf Shop",
      priority: "important",
    },
    {
      id: "cw-announcement-range",
    ...
    {
      id: "cw-announcement-dining",
      title: "Casual Dining & Bar",
      body: "Casual Dining serves breakfast, lunch, and dinner. To Go is open for cocktails and small plates. To Go, pool, and wedding event spaces available — inquire with Membership.",
      author: "Dining",
      priority: "normal",
    },
  ] as const;
  ...
  for (const a of announcements) {
    await prisma.announcement.upsert({
      where: { id: a.id },
      create: { ...a, communityId: CARROLLWOOD_COMMUNITY_ID },
      update: {
        title: a.title,
        body: a.body,
        author: a.author,
...
async function seedDocuments() {
  const documents = [
    {
      id: "cw-document-club-guide",
      title: "Carrollwood Country Club — Member Guide 2026",
      category: "membership",
      url: "#",
    ...
    {
      id: "cw-document-dining",
      title: "Dining Hours — Casual Dining — To Go",
      category: "dining",
      url: "#",
    ...
    {
      id: "cw-document-real-estate",
      title: "Featured Homes — Carrollwood Realty Listings",
      category: "real_estate",
      url: "#",
      uploadedBy: "Membership — Carrollwood Realty",
      daysAgo: 4,
    },
    {
      id: "cw-document-governance",
...
async function seedGroups() {
  const groups = [
    ...
    },
    {
      id: "cw-group-dining",
      name: "Dining & Lounge",
      description: "Casual Dining lunch daily and To Go sunrise?sunset.",
    ...
    {
      id: "cw-group-newcomers",
      name: "New Member Welcome",
      description: "Welcome notes, ride shares, and recommendations around Carrollwood Blvd and the club.",
...
async function seedFavorites() {
  const plans: Array<{ email: string; label: string; href: string }> = [
    ...
    { email: SOCIAL_EMAIL, label: "To Go", href: "/member/dining" },
...
async function seedMessages() {
  ...
  const michael = { email: "golf@carrollwoodcc.com", name: "Mike Torres" };
  const laura = { email: "golf.assistant@carrollwoodcc.com", name: "Jamie Chen" };
  const sophia = { email: "aquatics@carrollwoodcc.com", name: "Nina Patel" };
  const megan = { email: "events@carrollwoodcc.com", name: "Morgan Blake" };
  ...
  const threads: Array<{
    ...
    {
      id: "cw-chat-claire-robert",
      createdBy: robert.email,
      participants: [claire, robert],
      messages: [
        {
          author: robert,
          body: "Taylor — member social tonight at 5 if you're free. Loser buys To Go smoothies?",
          hoursAgo: 9,
        },
        {
          author: claire,
    ...
    {
      id: "cw-chat-robert-dining",
      createdBy: robert.email,
      participants: [robert, dining],
      messages: [
        {
          author: robert,
          body: "Can we hold To Go seating Sunday for four? Visiting family.",
          hoursAgo: 16,
        },
        {
          author: dining,
          body: "Absolutely — To Go table held for noon. Happy hour starts at 4 if you want to linger.",
          hoursAgo: 14,
        },
        {
          author: robert,
    ...
    {
      id: "cw-chat-claire-patricia",
      createdBy: patricia.email,
      participants: [claire, patricia],
      messages: [
        {
          author: patricia,
          body: "Taylor — 17501 Carrollwood Blvd is still active. Want the updated listing packet with golf membership notes?",
          hoursAgo: 22,
        },
        {
          author: claire,
        ...
        {
          author: patricia,
          body: "Packet sent. Call Carrollwood Realty if you need anything before showings.",
          hoursAgo: 19,
        },
      ],
    },
    {
      id: "cw-chat-frederick-claire",
    ...
    },
    {
      ...
      messages: [
        ...
        {
          author: claire,
          body: "Yes — see you at 4. Loser buys To Go smoothies?",
          hoursAgo: 3,
        },
      ],
    },
...
export async function ensureCarrollwoodDemoSeeded(): Promise<void> {
  if (!process.env.DATABASE_URL) return;
  if (!isDemoSeedAllowed()) return;

  await prisma.community.upsert({
    where: { id: CARROLLWOOD_COMMUNITY_ID },
    create: {
      id: CARROLLWOOD_COMMUNITY_ID,
  ...
  for (const user of [
    { id: "u-cw-member", email: MEMBER_EMAIL, role: "member", name: MEMBER_NAME },
    { id: "u-cw-member-social", email: SOCIAL_EMAIL, role: "member", name: SOCIAL_NAME },
    { id: "u-cw-pm", email: PM_EMAIL, role: "pm", name: PM_NAME },
    { id: "u-cw-board", email: BOARD_EMAIL, role: "board", name: BOARD_NAME },
  ] as const) {
  ...
  for (const profile of [
    {
      email: MEMBER_EMAIL,
      membershipTier: "golf",
      unit: "17501 Carrollwood Blvd",
      householdAddress: "17501 Carrollwood Blvd, Tampa, FL 33618",
    },
    {
      email: SOCIAL_EMAIL,
      membershipTier: "social",
      unit: "17503 Carrollwood Blvd",
      householdAddress: "17503 Carrollwood Blvd, Tampa, FL 33618",
    },
  ] as const) {
  ...
  await ensureMembershipTiersSeeded(CARROLLWOOD_COMMUNITY_ID);
  await seedAmenities();
...
export async function ensureCarrollwoodDemoServiceRequests(): Promise<void> {
  if (!process.env.DATABASE_URL) return;
  if (!isDemoSeedAllowed()) return;
  await seedServiceRequests();
}
...
export async function ensureCarrollwoodDemoApparel(): Promise<void> {
  if (!process.env.DATABASE_URL) return;
  if (!isDemoSeedAllowed()) return;
  await seedApparel();
}
...
export async function ensureCarrollwoodDemoMarketplace(): Promise<void> {
  if (!process.env.DATABASE_URL) return;
  if (!isDemoSeedAllowed()) return;
  await seedMarketplace();
}
...
export async function ensureCarrollwoodDemoBlog(): Promise<void> {
  if (!process.env.DATABASE_URL) return;
  if (!isDemoSeedAllowed()) return;
  await seedBlog();
}
...
export async function ensureCarrollwoodDemoNewsletters(): Promise<void> {
  if (!process.env.DATABASE_URL) return;
  if (!isDemoSeedAllowed()) return;
  await seedNewsletters();
}
...
export async function ensureCarrollwoodDemoGallery(): Promise<void> {
  if (!process.env.DATABASE_URL) return;
  if (!isDemoSeedAllowed()) return;
  await seedGallery();
}
...
export async function ensureCarrollwoodDemoPropertiesAndRealEstate(): Promise<void> {
  if (!process.env.DATABASE_URL) return;
  if (!isDemoSeedAllowed()) return;
  await seedProperties();
  await seedRealEstate();
...
async function seedServiceRequests() {
  const rows = [
    ...
    },
    {
      ...
      memberName: MEMBER_NAME,
      unit: "17501 Carrollwood Blvd",
      title: "Irrigation overspray on Carrollwood Blvd driveway",
      category: "Landscaping",
      description:
        "Common-area heads near 17501 Carrollwood Blvd soak the paver driveway every morning around 5:30am.",
      status: "in_progress",
      daysAgo: 4,
    },
    {
...
async function seedApparel() {
  const proShop = "Carrollwood Pro Shop";
  const apparel = [
    {
      id: "cw-apparel-polo-navy",
      name: "Club Polo — Navy",
      description: "Performance pique polo with embroidered Carrollwood crest.",
      price: 58,
      category: "Polo",
      sizesJson: '["S","M","L","XL","XXL"]',
      imageUrl: "/brand/apparel/cw-apparel-polo-navy.png",
    },
    {
      id: "cw-apparel-ladies-polo",
      name: "Ladies Sleeveless Polo — White",
      description: "Moisture-wicking sleeveless polo with club crest — ideal for warm Carrollwood rounds.",
      price: 52,
      category: "Polo",
      sizesJson: '["XS","S","M","L","XL"]',
      imageUrl: "/brand/apparel/cw-apparel-ladies-polo.png",
    },
    {
      id: "cw-apparel-quarter-zip",
      name: "Member Quarter-Zip — Heather Grey",
      description: "Lightweight layer for cool Carrollwood mornings on the championship course.",
      price: 78,
      category: "Outerwear",
      sizesJson: '["S","M","L","XL","XXL"]',
      imageUrl: "/brand/apparel/cw-apparel-quarter-zip.png",
    },
    {
      id: "cw-apparel-cap",
      name: "Performance Cap — Navy",
      description: "Structured adjustable cap with embroidered Carrollwood crest.",
      price: 32,
      category: "Accessories",
      sizesJson: '["One Size"]',
      imageUrl: "/brand/apparel/cw-apparel-cap-navy.png",
    },
    {
      id: "cw-apparel-visor",
      ...
      category: "Accessories",
      sizesJson: '["One Size"]',
      imageUrl: "/brand/apparel/cw-apparel-visor-black.png",
    },
    {
      id: "cw-apparel-towel",
      ...
      category: "Accessories",
      sizesJson: '["One Size"]',
      imageUrl: "/brand/apparel/cw-apparel-towel.png",
    },
  ] as const;
    ...
    await prisma.apparelOrder.create({
      data: {
        ...
        itemsJson: JSON.stringify([
          {
            productId: "cw-apparel-polo-navy",
            name: "Club Polo — Navy",
            size: "M",
            qty: 1,
            unitPrice: 58,
...
async function seedMarketplace() {
  const listings = [
    {
      id: "cw-marketplace-golf-balls",
      title: "Titleist Pro V1 Dozen",
      description: "Unopened dozen — switching to Left Dash. Pickup on Carrollwood after golf.",
      price: 42,
      category: "Golf",
      seller: MEMBER_NAME,
      unit: "17501 Carrollwood Blvd",
    ...
    {
      id: "cw-marketplace-patio",
      title: "Lanai Dining Set, 6 Chairs",
      description: "Weather-resistant table and six chairs. Local pickup on Carrollwood Blvd only.",
      price: 295,
      category: "Home",
      seller: SOCIAL_NAME,
      unit: "17503 Carrollwood Blvd",
    ...
    {
      id: "cw-marketplace-callaway-junior",
...
async function seedBlog() {
  const posts = [
    {
      id: "cw-blog-five-courses",
      title: "Playing the championship course this season",
      excerpt:
        "Director of Golf Mike Torres shares tips for Carrollwood's 18 holes.",
      body: "Carrollwood members enjoy 18 holes — 18-hole championship golf course. Book early mornings for the coolest conditions and ask the pro shop about member events.",
      author: "Mike Torres, PGA",
      category: "Golf",
      daysAgo: 1,
    },
    {
      id: "cw-blog-breezeway",
      title: "To Go favorites after golf",
      excerpt:
        "Breakfast, lunch, and small plates from through early evening.",
      body: "After a morning round, To Go is the easy stop for light plates and cold drinks. Casual Dining picks up lunch daily — reserve through Dining in the member app.",
      author: "Carrollwood Dining",
      category: "Dining",
      daysAgo: 3,
    },
    {
      id: "cw-blog-golf-community",
      title: "18 holes, one thriving golf community",
      excerpt:
        "Pool socials and short-game clinics on the practice greens.",
      body: "With 18 holes across the championship course — private equity championship golf — Carrollwood runs member events so everyone meets more members. Book a tee time in the app, arrive early for the practice putting and chipping, and stay for To Go afterward.",
      author: "Jamie Chen",
      category: "Golf",
      daysAgo: 5,
    },
    {
      id: "cw-blog-golf-tips",
      title: "Practice range & greens — warm-up tips",
      excerpt: "Get the most from Carrollwood's practice facilities before you tee off.",
    ...
    {
      id: "cw-blog-lifestyle",
      title: "Pro Shop summer programming",
      excerpt:
        "Range clinics, lounge gatherings, and Pro Shop hours for the warm season.",
      body: "Warm up before tee times on the practice putting and chipping, then recover at To Go. Group clinics fill quickly — check the calendar. The Pro Shop opens early for apparel and equipment.",
    ...
    {
      id: "cw-blog-welcome",
      title: "Welcome to Carrollwood Country Club",
      excerpt:
        "Simple ways to settle in — golf, dining, and community groups.",
      body: "Start with a casual meal at Casual Dining or To Go, join a community group in the app, and book one clinic on the calendar. Membership can help with guest passes and real-estate questions.",
      author: "Alex Morgan",
      category: "Community",
      daysAgo: 12,
    },
  ...
  const comments = [
    {
      id: "cw-blog-comment-golf-1",
      postId: "cw-blog-five-courses",
      author: MEMBER_NAME,
      body: "The course at dawn is unbeatable — thanks for the tips, Mike!",
    },
    {
      id: "cw-blog-comment-golf-2",
      postId: "cw-blog-five-courses",
      author: SOCIAL_NAME,
      body: "Championship Course was in perfect shape last weekend.",
    },
    {
      id: "cw-blog-comment-breezeway-1",
      postId: "cw-blog-breezeway",
      author: MEMBER_NAME,
      body: "To Go after golf is our Saturday ritual now.",
    },
    {
      id: "cw-blog-comment-community-1",
      postId: "cw-blog-golf-community",
      author: SOCIAL_NAME,
      body: "Pool & Aquatics Social was packed but so welcoming. Counting me in next month.",
    },
  ] as const;
...
async function seedNewsletters() {
  const newsletters = [
    {
      id: "cw-newsletter-july-2026",
      title: "Carrollwood Country Club Summer Update — July 2026",
      summary:
        "the championship course in peak condition, lounge socials, and July calendar highlights.",
      body: [
        "Members,",
        "",
        "Summer is in full swing at Carrollwood Country Club. Our 18 holes — 18-hole championship course, private equity championship golf — are in excellent condition. Early tee times remain the coolest window for 18 holes.",
        "",
        "This month:",
        "? Casual Dining (lunch Tue?Sun) and To Go (sunrise?sunset) — reserve in Dining",
        "? Clubhouse terrace social with live music",
        "? Pool & Aquatics Social — book through the pro shop",
        "",
        "Questions: Membership — (813) 961-1381 — 17501 Carrollwood Blvd, Tampa, FL 33618 — membership@carrollwoodcc.com — https://www.carrollwoodcc.com",
        "",
        "? Alex Morgan",
        "General Manager",
      ].join("\n"),
    ...
    },
    {
      ...
      body: [
        ...
        "",
        "Pro Shop: Crest polos, caps, and towels stocked — order through Club Apparel in the app — (813) 961-1381.",
        "",
        "? Golf Shop",
      ].join("\n"),
      daysAgo: 8,
    ...
    {
      id: "cw-newsletter-dining",
      title: "Dining at Carrollwood — Midsummer Menus",
      summary:
        "Casual Dining/Lounge lunch daily — Casual Dining seasonal.",
      body: [
        "Dining members,",
        "",
        "Summer menus are live across Casual Dining (lunch Tue?Sun) and To Go (sunrise?sunset). After golf, To Go is the easy stop. Lunch reservations for Casual Dining book quickly on weekends.",
        "",
        ...
        "",
        "? Carrollwood Dining",
        "dining@carrollwoodcc.com",
      ].join("\n"),
      daysAgo: 14,
    },
    {
      id: "cw-newsletter-membership",
      title: "Membership Notes & Community Spotlight",
      summary:
        "Guest passes, directory updates, Carrollwood Realty, and connecting in the app.",
      body: [
        "Members,",
        "",
        "Welcome to our newest Carrollwood neighbors. Use Directory, Groups, Marketplace, and Documents in the app to settle in. Guest pass requests can be submitted as Service Requests or through Membership.",
        "",
        "Carrollwood does not require any minimum spending at the club. We offer a wide variety of dining experiences, frequent menu changes, and social events so members choose to dine with us.",
        "",
        "For Membership and real-estate questions, contact Membership at membership@carrollwoodcc.com — (813) 961-1381 — 17501 Carrollwood Blvd, Tampa, FL 33618.",
        "",
        "Thank you for making Carrollwood Country Club a vibrant member community.",
        "",
...
async function seedGallery() {
  const images = [
    ...
    {
      id: "cw-gallery-dining",
      title: "Casual Dining",
      category: "Dining",
      url: brandAssets.featuredDining,
      uploadedBy: "Carrollwood Dining",
      daysAgo: 7,
    },
  ] as const;
...
async function seedProperties() {
  const properties = [
    {
      id: "cw-property-claire-primary",
      userEmail: MEMBER_EMAIL,
      address: "17501 Carrollwood Blvd, Tampa, FL 33618",
      type: "Primary residence",
      owner: true,
    },
    {
      id: "cw-property-claire-guest",
      userEmail: MEMBER_EMAIL,
      address: "17510 Carrollwood Blvd, Tampa, FL 33618",
      type: "Investment property",
      owner: true,
    },
    {
      id: "cw-property-robert-primary",
      userEmail: SOCIAL_EMAIL,
      address: "17503 Carrollwood Blvd, Tampa, FL 33618",
      type: "Primary residence",
      owner: true,
    },
  ] as const;
...
async function seedRealEstate() {
  const patriciaEmail = "membership@carrollwoodcc.com";
  const listings = [
    {
      id: "cw-real-estate-bay-harbor",
      memberEmail: patriciaEmail,
      title: "Carrollwood Estate with Lake Views",
      description:
        "Updated four-bedroom estate with lanai, pool, and golf cart garage. Course views and easy access to the Championship Course. Listed with Membership — membership@carrollwoodcc.com.",
      type: "sale",
      price: 1895000,
      beds: 4,
      baths: 3.5,
      sqft: 3420,
      unit: "17520 Carrollwood Blvd",
      color: "from-sky-600 to-teal-800",
      images: [brandAssets.amenityLodging, brandAssets.galleryClubhouseTerrace],
      daysAgo: 2,
    },
    {
      id: "cw-real-estate-country-club",
      memberEmail: patriciaEmail,
      title: "Carrollwood Blvd Villa",
      description:
    ...
    {
      id: "cw-real-estate-creekside-rent",
      memberEmail: patriciaEmail,
      title: "Furnished Seasonal Rental — Carrollwood Blvd",
      description:
